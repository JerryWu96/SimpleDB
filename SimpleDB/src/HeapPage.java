...
public class HeapPage implements Page {
    ...
    */
    ...
    public HeapPageId getId() {
        // some code goes here
    	return this.pid;
    	// is the following statement an indicator that we don't need to implement???
    ...
    public boolean isSlotUsed(int i) {
        // some code goes here
         ...
         int offset = i % 8;
         int tmp = 1 << offset;
         return (this.header[byteLoc] & tmp) != 0;
    }
    ...
    // Added:
    /**
     * Returns number of occupied tuples
    **/
    public int occupiedTuples() {
